...
The Pridnestrovian Moldavian Republic dictionary, consists of the country's raions, municipality and their information.
...
- `"population"`: Population of the raion or municipality, type: `int`
...
# Creates the list of all raions
