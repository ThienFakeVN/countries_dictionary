...
Before using, it is recommended to read the [documentation site](https://ThienFakeVN.github.io/countries_dictionary/) to understand how the module works and how you can use it.
